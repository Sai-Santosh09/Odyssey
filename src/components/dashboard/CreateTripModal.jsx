...
import { searchPlacesAutocomplete, verifyDestinationLocation } from '../../services/mapsService';
...
export function CreateTripModal({
    ...
    const [destinationCoords, setDestinationCoords] = useState({ lat: 15.2993, lng: 74.1240 });
    ...
    // When destination input changes, search via Places Autocomplete API
    useEffect(() => {
    ...
    const handleSelectPrediction = (pred) => {
        ...
        setDestinationCoords({ lat: pred.lat || 15.2993, lng: pred.lng || 74.1240 });
        setIsVerified(true);
