...
export function NearYou({
    ...
    return (
        <section className="space-y-3.5 pt-4">
            ...
            <div className="flex items-center justify-between">
                <div>
                    <div className="flex items-center gap-2">
                        ...
                        {isRadarExpanded ? (
                            ...
                            <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[10px] font-bold bg-slate-100 dark:bg-odyssey-navy text-odyssey-slate dark:text-odyssey-tan">
                                <Radio className="w-2.5 h-2.5 text-odyssey-brown dark:text-odyssey-tan" />
                                Local 6km Radar
                            </span>
                        )}
                    </div>
                    <p className="text-xs text-odyssey-slate dark:text-odyssey-tan mt-0.5 flex items-center gap-1.5">
                ...
                <div className="flex items-center gap-2">
                    ...
                    <button
                        ...
                        className="p-1.5 rounded-xl bg-slate-100 dark:bg-odyssey-navy hover:bg-slate-200 dark:hover:bg-slate-700 text-odyssey-slate dark:text-odyssey-tan transition-all active:rotate-180"
                        title="Re-scan Live Radar"
                        aria-label="Re-scan Live Radar"
                    >
                        <RefreshCw className={`w-3.5 h-3.5 ${isLoadingPlaces ? 'animate-spin text-odyssey-brown dark:text-odyssey-tan' : ''}`} />
                    </button>

                    {/* View Switcher */}
                    <div className="flex items-center p-0.5 bg-slate-100 dark:bg-odyssey-navy rounded-xl border border-odyssey-tan/40 dark:border-odyssey-brown/50">
                        <button
                            onClick={() => setViewMode('list')}
                            className={`p-1.5 rounded-lg transition-all ${
                                viewMode === 'list'
                                    ? 'bg-white dark:bg-odyssey-slate text-odyssey-brown dark:text-odyssey-tan shadow-xs'
                                    : 'text-slate-400 hover:text-odyssey-slate dark:hover:text-slate-200'
                            }`}
                            title="List View"
                        >
                    ...
                    <button
                        ...
                        className={`flex items-center gap-1.5 px-2.5 py-1 rounded-full border text-[11px] font-bold transition-all active:scale-95 touch-manipulation ${
                            gpsState === 'granted'
                                ...
                                : 'bg-slate-100 dark:bg-odyssey-navy hover:bg-slate-200 dark:hover:bg-slate-700 text-odyssey-slate dark:text-odyssey-tan border-odyssey-tan/40 dark:border-odyssey-brown/50'
                        }`}
                        title="Click to locate using device GPS"
                    >
                        {gpsState === 'locating' ? (
                            <>
                                <Loader2 className="w-3 h-3 animate-spin text-odyssey-brown dark:text-odyssey-tan" />
                                <span>Locating...</span>
                            </>
                        ) : gpsState === 'granted' ? (
                            <>
                            ...
                            <>
                                <Navigation className="w-3 h-3 text-odyssey-brown dark:text-odyssey-tan" />
                                <span>Use GPS</span>
                            </>
                        )}
                    </button>
            ...
            <div className="p-2 rounded-2xl bg-slate-50 dark:bg-[#111827] border border-odyssey-tan/40/80 dark:border-odyssey-brown/50 flex items-center justify-between gap-2 text-xs">
                <div className="flex items-center gap-1.5 overflow-x-auto scrollbar-none">
                    <span className="text-[11px] font-bold text-odyssey-slate dark:text-odyssey-tan flex items-center gap-1 pl-1">
                        <Compass className="w-3.5 h-3.5 text-odyssey-brown dark:text-odyssey-tan" />
                        <span>Radius:</span>
                    </span>
                    {[
                        ...
                        <button
                            ...
                            className={`px-2.5 py-1 rounded-xl text-[11px] font-bold whitespace-nowrap transition-all ${
                                searchRadiusKm === r.km
                                    ...
                                    : 'bg-white dark:bg-odyssey-slate text-odyssey-slate dark:text-odyssey-tan hover:text-odyssey-navy dark:hover:text-white border border-odyssey-tan/40 dark:border-odyssey-brown/50'
                            }`}
                        >
                            {r.label}
                        </button>
                ...
                <button
                    ...
                    className={`hidden sm:flex items-center gap-1 px-2.5 py-1 rounded-xl text-[11px] font-bold transition-all ${
                        autoExpandEnabled
                            ...
                            : 'text-odyssey-slate bg-white dark:bg-odyssey-slate border border-odyssey-tan/40 dark:border-odyssey-brown/50'
                    }`}
                ...
                {[
                    ...
                    <button
                        ...
                        className={`px-3 py-1.5 rounded-xl text-xs font-semibold whitespace-nowrap transition-all duration-150 active:scale-95 touch-manipulation ${
                            filter === tab.id
                                ? 'bg-slate-900 dark:bg-white text-white dark:text-odyssey-navy shadow-xs'
                                : 'bg-white dark:bg-odyssey-slate hover:bg-slate-100 dark:hover:bg-[#182238] text-odyssey-slate dark:text-odyssey-tan border border-odyssey-tan/40 dark:border-odyssey-brown/50'
                        }`}
                    >
                        {tab.label}
                    </button>
            ...
            {isLoadingPlaces ? (
                <div className="bg-white dark:bg-odyssey-slate rounded-3xl p-8 border border-odyssey-tan/40 dark:border-odyssey-brown/50 text-center flex flex-col items-center justify-center space-y-3">
                    <div className="w-12 h-12 rounded-2xl bg-odyssey-cream/60 dark:bg-odyssey-navy dark:bg-odyssey-navy text-odyssey-brown dark:text-odyssey-tan flex items-center justify-center animate-bounce">
                    ...
                    <div>
                        ...
                        <p className="text-xs text-odyssey-slate dark:text-odyssey-tan mt-1">
                            {radarStatusMsg}
                        </p>
                    </div>
                </div>
            ) : filtered.length === 0 ? (
                <div className="bg-white dark:bg-odyssey-slate rounded-3xl p-6 text-center border border-odyssey-tan/40 dark:border-odyssey-brown/50">
                    <p className="text-xs font-semibold text-odyssey-slate dark:text-odyssey-tan">No places found in this category.</p>
                    <button
                        onClick={() => handleManualRadiusSelect(35)}
                        className="text-xs text-odyssey-brown dark:text-odyssey-tan font-bold mt-1.5 hover:underline"
                    >
                            ...
                            return (
                                <button
                                    ...
                                    className={`p-2.5 rounded-2xl border text-left text-xs whitespace-nowrap flex items-center gap-2.5 transition-all flex-shrink-0 ${
                                        isSelected
                                            ? 'bg-odyssey-cream/60 dark:bg-odyssey-navy dark:bg-odyssey-navy border-odyssey-tan/40 dark:border-odyssey-brown/50 text-odyssey-brown dark:text-odyssey-tan font-bold shadow-xs'
                                            : 'bg-white dark:bg-odyssey-slate border-odyssey-tan/40 dark:border-odyssey-brown/50 text-odyssey-slate dark:text-odyssey-tan hover:border-odyssey-tan/60 dark:hover:border-slate-700'
                                    }`}
                                >
                    ...
                    {filtered.map((place) => {
                        ...
                        return (
                            <div
                                ...
                                className="group bg-white dark:bg-odyssey-slate rounded-2xl p-3 sm:p-3.5 border border-odyssey-tan/40 dark:border-odyssey-brown/50 shadow-sm hover:shadow-md hover:border-odyssey-tan/40 dark:border-odyssey-brown/50 transition-all duration-200 cursor-pointer flex items-center justify-between gap-3"
                            >
                                <div className="flex items-center gap-3 min-w-0 flex-1">
                                    ...
                                    <div className="space-y-0.5 min-w-0 flex-1">
                                        <div className="flex items-center flex-wrap gap-1.5">
                                            <h4 className="text-xs sm:text-sm font-bold text-odyssey-navy dark:text-odyssey-cream group-hover:text-odyssey-brown dark:text-odyssey-tan transition-colors truncate">
                                                {place.name}
                                            </h4>
                                            <span className="px-1.5 py-0.5 rounded-md text-[10px] font-semibold bg-slate-100 dark:bg-odyssey-navy text-odyssey-slate dark:text-odyssey-tan flex-shrink-0">
                                                {place.category}
                                            </span>
                                            {place.isIconic && (
                                        ...
                                        <p className="text-[11px] text-odyssey-slate dark:text-odyssey-tan line-clamp-1">
                                            {place.description}
                                        </p>

                                        <div className="flex items-center gap-3 text-[11px] text-odyssey-slate dark:text-odyssey-tan pt-0.5">
                                            ...
                                            <span className="text-slate-400 dark:text-odyssey-tan/80 hidden xs:inline">{place.timings}</span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-center gap-1.5 flex-shrink-0">
                                    <a
                                        ...
                                        className="p-2 rounded-xl bg-slate-50 dark:bg-odyssey-navy hover:bg-odyssey-cream/60 dark:bg-odyssey-navy dark:hover:bg-orange-950/40 text-slate-400 hover:text-odyssey-brown dark:text-odyssey-tan transition-colors hidden xs:flex items-center"
                                    ...
                                    <button
                                        ...
                                        className="p-2 rounded-xl bg-slate-50 dark:bg-odyssey-navy group-hover:bg-odyssey-brown text-odyssey-cream dark:bg-odyssey-tan dark:text-odyssey-navy text-odyssey-slate dark:text-odyssey-tan group-hover:text-white transition-all flex items-center gap-1 text-xs font-semibold shadow-xs"
                                    >
