...
export function CancelTripModal({
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-odyssey-navy/70 backdrop-blur-sm animate-in fade-in duration-200">
            <div className="bg-white dark:bg-odyssey-slate rounded-3xl max-w-sm w-full p-5 space-y-4 shadow-2xl border border-odyssey-tan/40 dark:border-odyssey-brown/50 animate-in zoom-in-95 duration-200 transition-colors">
                <div className="flex items-center justify-between border-b border-odyssey-tan/30 dark:border-odyssey-brown/50 pb-3">
                    ...
                    <button
                        onClick={onClose}
                        className="p-1 rounded-full text-slate-400 hover:text-odyssey-slate dark:hover:text-slate-200"
                    >
                        <X className="w-4 h-4" />
                    </button>
                </div>
                ...
                <div className="space-y-2">
                    <p className="text-xs text-odyssey-slate dark:text-odyssey-tan">
                        Are you sure you want to cancel your planned journey to <strong className="text-odyssey-navy dark:text-odyssey-cream">{trip.title}</strong> ({trip.dates})?
                    </p>
                ...
                <div className="pt-2 flex gap-2.5">
                    <button
                        onClick={onClose}
                        className="flex-1 py-2.5 bg-slate-100 dark:bg-odyssey-navy hover:bg-slate-200 dark:hover:bg-slate-700 text-odyssey-slate dark:text-odyssey-cream font-semibold text-xs rounded-xl transition-colors"
                    >
                        Keep Trip
                    </button>
                    <button
