...
export function TripDetailsModal({
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 bg-black/70 backdrop-blur-md animate-in fade-in duration-200">
            <div className="bg-white dark:bg-[#131B2E] rounded-[28px] max-w-xl w-full max-h-[92vh] overflow-y-auto shadow-2xl border border-slate-200 dark:border-slate-800/90 p-5 sm:p-7 space-y-5 animate-in zoom-in-95 duration-200 transition-colors relative selection:bg-[#F06536]/20 selection:text-[#F06536]">
                ...
                <div className="border-b border-slate-100 dark:border-slate-800 pb-3.5 space-y-2.5">
                    <div className="flex items-start justify-between gap-3">
                        <div className="space-y-1">
                            <div className="flex items-center gap-2 flex-wrap">
                                ...
                                <span className="px-2.5 py-0.5 rounded-full text-[10px] font-extrabold bg-orange-100 dark:bg-orange-950/50 text-[#F06536] border border-orange-200 dark:border-orange-900/60">
                        ...
                        <div className="flex items-center gap-1.5 flex-shrink-0">
                            <button
                                ...
                                className={`px-2.5 py-1.5 rounded-xl text-xs font-bold transition-all flex items-center gap-1.5 border ${
                                    isEditingDetails
                                        ? 'bg-orange-50 dark:bg-orange-950/50 text-[#F06536] border-orange-300 dark:border-orange-800'
                                        : 'bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-300 border-slate-200 dark:border-slate-700 hover:text-[#F06536]'
                                }`}
                    ...
                    <div className="bg-slate-50 dark:bg-slate-900/80 p-2.5 rounded-2xl border border-slate-200/80 dark:border-slate-800 flex items-center justify-between gap-3">
                        <div className="flex items-center gap-2">
                            <div className="w-7 h-7 rounded-xl bg-orange-100 dark:bg-orange-950/50 text-[#F06536] flex items-center justify-center">
                                <Users className="w-3.5 h-3.5" />
                            </div>
                            <div>
                                <p className="text-[11px] font-extrabold text-slate-800 dark:text-slate-200">
                                    Number of People Traveling: <span className="text-[#F06536] text-xs font-black">{editForm.travelers} {editForm.travelers === 1 ? 'Traveler' : 'Travelers'}</span>
                                </p>
                        ...
                        <div className="flex items-center gap-1.5 bg-white dark:bg-[#131B2E] px-2 py-1 rounded-xl border border-slate-200 dark:border-slate-700 shadow-xs">
                            <button
                                type="button"
                                disabled={editForm.travelers <= 1}
                                onClick={() => handleQuickTravelersChange(-1)}
                                className="w-6 h-6 rounded-lg bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-200 flex items-center justify-center disabled:opacity-30 disabled:cursor-not-allowed cursor-pointer active:scale-95"
                ...
                {isEditingDetails && (
                    <form 
                        ...
                        className="bg-orange-50/50 dark:bg-orange-950/20 border-2 border-orange-200 dark:border-orange-900/60 rounded-3xl p-4 sm:p-5 space-y-4 animate-in fade-in slide-in-from-top-2 duration-200"
                    >
                        <div className="flex items-center justify-between border-b border-orange-100 dark:border-slate-800 pb-2.5">
                            <div className="flex items-center gap-1.5 text-xs font-extrabold text-slate-900 dark:text-white uppercase tracking-wider">
                                <Edit3 className="w-3.5 h-3.5 text-[#F06536]" />
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                            ...
                            <div className="space-y-1 sm:col-span-2">
                                ...
                                <input
                                    ...
                                    className="w-full px-3 py-2 rounded-xl bg-white dark:bg-[#131B2E] border border-slate-200 dark:border-slate-700 text-xs font-semibold text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-[#F06536]/30"
                            ...
                            <div className="space-y-1">
                                <label className="text-[11px] font-bold text-slate-700 dark:text-slate-300 flex items-center justify-between">
                                    ...
                                    <span className="text-[#F06536] font-extrabold">{editForm.travelers} people</span>
                                </label>
                                <div className="flex items-center gap-2 bg-white dark:bg-[#131B2E] p-1.5 rounded-xl border border-slate-200 dark:border-slate-700">
                                    <button
                                        type="button"
                                        disabled={editForm.travelers <= 1}
                                        onClick={() => setEditForm((prev) => ({ ...prev, travelers: Math.max(1, prev.travelers - 1) }))}
                                        className="w-7 h-7 rounded-lg bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-200 flex items-center justify-center disabled:opacity-30 cursor-pointer"
                                    >
                                        <Minus className="w-3 h-3" />
                                    </button>
                                    <input
                                        ...
                                        className="w-full text-center text-xs font-extrabold text-slate-900 dark:text-white bg-transparent focus:outline-none"
                                    />
                                    <button
                                        type="button"
                                        disabled={editForm.travelers >= 20}
                            ...
                            <div className="space-y-1">
                                <label className="text-[11px] font-bold text-slate-700 dark:text-slate-300 flex items-center justify-between">
                                    ...
                                    <span className="text-[#F06536] font-extrabold">{editForm.totalDays} Days</span>
                                </label>
                                <div className="flex items-center gap-2 bg-white dark:bg-[#131B2E] p-1.5 rounded-xl border border-slate-200 dark:border-slate-700">
                                    <button
                                        type="button"
                                        ...
                                        <button
                                            ...
                                            className={`px-2.5 py-1 rounded-lg text-[11px] font-semibold transition-all ${
                                                editForm.vibe === v
                                                    ...
                                                    : 'bg-white dark:bg-[#131B2E] text-slate-600 dark:text-slate-300 border border-slate-200 dark:border-slate-700 hover:border-slate-300'
                                            }`}
                                        >
                                            {v}
                                        </button>
                        ...
                        {/* Save & Cancel Actions */}
                        <div className="flex items-center justify-end gap-2 pt-2 border-t border-orange-100 dark:border-slate-800">
                            <button
                                type="button"
                            ...
                            <button
                                type="submit"
                                className="px-4 py-2 rounded-xl text-xs font-extrabold bg-[#F06536] hover:bg-[#E05325] active:scale-95 text-white transition-all shadow-md shadow-[#F06536]/25 flex items-center gap-1.5 cursor-pointer"
                            >
                ...
                {/* Sub Tab Navigation */}
                <div className="grid grid-cols-2 p-1 bg-slate-100 dark:bg-slate-900/90 rounded-2xl border border-slate-200/50 dark:border-slate-800/80">
                    <button
                    ...
                    <div className="space-y-4">
                        {loadingAi ? (
                            <div className="py-14 text-center space-y-3">
                                <Loader2 className="w-8 h-8 animate-spin text-[#F06536] mx-auto" />
                                <div className="space-y-1">
                            ...
                            <>
                                ...
                                <div className="bg-slate-50 dark:bg-slate-900/80 rounded-2xl p-4 border border-slate-200/80 dark:border-slate-800 space-y-3">
                                    ...
                                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
                                        <div className="bg-white dark:bg-[#131B2E] p-2.5 rounded-xl border border-slate-200 dark:border-slate-700 text-center ring-1 ring-sky-500/20">
                                        ...
                                        <div className="bg-white dark:bg-[#131B2E] p-2.5 rounded-xl border border-slate-200 dark:border-slate-700 text-center ring-1 ring-orange-500/20">
                                            <p className="text-[10px] text-[#F06536] font-bold uppercase">Hotels / Stays</p>
                                            <p className="text-xs font-extrabold text-[#F06536] mt-0.5">₹{costs.hotels.toLocaleString()}</p>
                                        </div>
                                ...
                                {transportComparisons.length > 0 && (
                                    ...
                                    >
                                        {/* Transit Card Header */}
                                        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 border-b border-sky-100 dark:border-slate-800/80 pb-3">
                                            ...
                                            <p className="text-[11px] text-slate-500 dark:text-slate-400 font-medium">
                                                Prices for <strong className="text-slate-900 dark:text-white font-bold">{editForm.travelers} Traveler(s)</strong>
                                            </p>
                                        </div>
                                                    ...
                                                    <div 
                                                        ...
                                                        className={`p-3 sm:p-3.5 rounded-2xl border transition-all duration-200 flex flex-col sm:flex-row sm:items-center justify-between gap-3 ${
                                                            isSelected
                                                                ...
                                                                : 'bg-white dark:bg-[#151D30]/90 border-slate-200/90 dark:border-slate-800 hover:border-slate-300 dark:hover:border-slate-700'
                                                        }`}
                                                    >
                                                        {/* Transit Mode Info */}
                                                        <div className="space-y-1">
                                                            ...
                                                            {transit.features && (
                                                                <div className="flex items-center gap-1.5 flex-wrap pt-0.5">
                                                                    {transit.features.map((feat, fidx) => (
                                                                        <span key={fidx} className="text-[10px] text-slate-500 dark:text-slate-400 bg-slate-100 dark:bg-slate-800/80 px-2 py-0.5 rounded-md border border-slate-200/50 dark:border-slate-700/50 flex items-center gap-1">
                                                        ...
                                                        {/* Price & Book CTA */}
                                                        <div className="flex items-center justify-between sm:justify-end gap-2.5 pt-2 sm:pt-0 border-t sm:border-t-0 border-slate-100 dark:border-slate-800 flex-shrink-0">
                                ...
                                {accommodation && (
                                    <div 
                                        ...
                                        className="bg-gradient-to-br from-orange-50/70 via-white to-amber-50/50 dark:from-[#151D30] dark:via-[#131B2E] dark:to-[#171A26] rounded-3xl p-4 sm:p-5 border-2 border-orange-200/90 dark:border-orange-900/60 shadow-lg shadow-orange-500/5 space-y-4 transition-all"
                                    >
                                        {/* Card Header & Recommended Hotel Info */}
                                        <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-3 border-b border-orange-100 dark:border-slate-800/80 pb-3.5">
                                            <div className="space-y-1">
                                                <div className="flex items-center gap-2 flex-wrap">
                                                    <span className="px-2.5 py-0.5 rounded-full text-[10px] font-extrabold bg-[#F06536] text-white flex items-center gap-1 shadow-xs">
                                                ...
                                                <p className="text-[11px] text-slate-500 dark:text-slate-400 flex items-center gap-1 font-medium">
                                                    ...
                                                    <span>•</span>
                                                    <span className="text-slate-700 dark:text-slate-300 font-semibold">{accommodation.room_type || 'Deluxe Room'}</span>
                                                </p>
                                            </div>
                                            ...
                                            <div className="text-left sm:text-right flex-shrink-0">
                                                ...
                                                <span className="text-base sm:text-lg font-black text-[#F06536]">
                                        ...
                                        {accommodation.amenities && (
                                            <div className="flex items-center gap-1.5 flex-wrap">
                                                {accommodation.amenities.map((amenity, idx) => (
                                                    <span 
                                                        key={idx}
                                                        className="px-2 py-0.5 rounded-md text-[10px] font-medium bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-300 border border-slate-200/60 dark:border-slate-700/60 flex items-center gap-1"
                                                    >
                                        ...
                                        <div className="space-y-2 pt-1">
                                            <div className="flex items-center justify-between px-1">
                                                <div className="flex items-center gap-1.5 text-[11px] font-extrabold text-slate-700 dark:text-slate-300 uppercase tracking-wider">
                                                    <Tag className="w-3 h-3 text-[#F06536]" />
                                                                ...
                                                                <div className="flex items-center gap-2">
                                                                    <span className="font-extrabold text-sm text-slate-900 dark:text-white flex items-center gap-1.5">
                                                                        ...
                                                                        {item.platform_name === 'Expedia' && (
                                                                            <span className="w-5 h-5 rounded-full bg-amber-400 text-slate-900 font-black text-[10px] flex items-center justify-center shadow-xs">
                                                                                E
                                                                            </span>
                                                                        )}
                                                                ...
                                                                <div className="text-left sm:text-right">
                                                                    <div className="flex items-baseline gap-1 sm:justify-end">
                                                                        <span className={`text-base sm:text-lg font-black ${
                                                                            isCheapest ? 'text-emerald-600 dark:text-emerald-400' : 'text-slate-900 dark:text-white'
                                                                        }`}>
